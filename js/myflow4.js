$(document).ready(function(){
                    ...
                    return function(){
                        // shapeArr[i].re.click(function(){
                            ...
                            if(window.isSelected){
                                ...
                                window.setInterval(fun(line),50);
                            }else{
                                //这个是起点
                                path[0] = shapeArr[i];
                                //在这里这个的起点设置为true
    ...
    function focusShape(data,ele){
        ...
        // console.log(data);
        var tempEle = ele ? ele.getName() : "默认值"
            ,tempDes  = ele ? ele.getDescription() : "默认值";
        //显示该元素的属性框
        var html = '<div class="content">'
                    ...
                    +'<div class="form">'
                        +'<div>'
                            ...
                            +'<input class="span2" type="text" id="name" value="'+tempEle+'"/>'
                        +'</div>'
                        +'<div>'
                            +'<label for="description">描述</label>'
                            +'<textarea class="span2" name="description" id="description" cols="20" rows="2">'+tempDes+'</textarea>'
                        +'</div>'
                        +'<div class="butt">'
    ...
    function shapeFactroy(x,y,type,name){
        ...
        if(type == 'circle'){
            ...
            oReturn = new Circle(x,y,type,tempName);
