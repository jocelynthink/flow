$(document).ready(function(){
    ...
    function bind_line(){
        ...
        for(var i = 0;i < lineArr.length; i ++){
            ...
            lineArr[i].timer = window.setInterval(fun(i),50);
        }
    }
    function bind_text(){
        for(var i = 0;i < textArr.length;i ++){
            ...
            textArr[i].timer = window.setInterval(fun(i),50);
        }
    }
    ...
    /*设计一个类，实现各种不同的形状的画图,这是一个抽象类,text是z类型的变量，*/
    function Shape(x,y,type,name){
        ...
        this.re = null;
        // this.text = text; //每一个形状应该有一个对应的文字的
    ...
    /*圆形继承自形状*/
    function Circle(x,y,type,name,text){
        Shape.call(this,x,y,type,name,text);
        /*下面这个是构造函数*/
    ...
    /*矩形类继承自形状*/
    function Rect(x,y,type,name,text){
    ...
    /*菱形类继承系形状*/
    function Rhombus(x,y,type,name,text){
        Shape.call(this,x,y,type,name);
        that = this;
        this.createShape = function(type){
            this.name="选择";
